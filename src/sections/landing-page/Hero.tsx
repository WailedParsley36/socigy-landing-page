            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="pt-48 pb-16 md:pt-52 md:pb-32">
                    ...
                    <div className="mx-auto text-center">
                        ...
                        <h1 style={{ letterSpacing: ".85rem" }} className="h1 bg-clip-text leading-snug text-transparent text-7xl bg-gradient-to-r from-slate-100/60 via-slate-100 to-slate-100/60 pb-4 font-inter font-extrabold" data-aos="fade-down">
                            <div>
                                SOCIAL NETWORK
                            </div>
                        ...
                        <div className='max-w-2xl text-center mx-auto'>
                            ...
                            <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4" data-aos="fade-down" data-aos-delay="400">
                                <div>
                                    <Link className="btn text-slate-900 bg-gradient-to-r from-white/80 via-white to-white/80 hover:bg-white w-full transition duration-150 ease-in-out group" href="#0">
