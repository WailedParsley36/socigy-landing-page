      ...
      <div className="mx-auto px-4 md:px-12 lg:px-16 py-2 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <ul className="flex-1 flex justify-end items-center">
            ...
            <li className="ml-6">
              <Link
                className="btn-sm text-slate-300 hover:text-white border border-slate-300 transition duration-150 ease-in-out w-full group relative before:absolute before:inset-0 before:bg-slate-800/30 before:rounded-full before:pointer-events-none"
                to="/waitlist"
              >
