...
import FamilyIcon from "../../assets/icons/family-content.svg";
import ExternalLink from "../../assets/icons/external-open.svg";
  ...
  return (
    <>
      <Highlighter className="group">
        <HighlighterItem02>
          <div className="p-8 relative h-full bg-blacky-500 rounded-[inherit] z-20 overflow-hidden">
            {/* Blurred shape */}
            <div className="absolute right-0 bottom-0 blur-2xl" aria-hidden="true">
            ...
            <p className="text-slate-400 mb-10">
              Display your connections in a playfull way
            </p>
          ...
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              >
                {/* Content #1 */}
                <div>
                  <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-primary-red to-primary-yellow pb-3">
                    First personalized social network
                  </div>
                </div>
                <h3 className="h3 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-3">
                  Personalize, Control and Manage your own social network
                </h3>
                <p className="text-lg text-slate-400 mb-8">
                  Make your own social network and change how it should behave.
                  Frustrated by current platforms? We've got you covered!
                </p>
                  ...
                  {features.map((x, index) => (
                    <button
                      ...
                      className={`flex items-center text-sm font-medium text-slate-50 rounded border bg-slate-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${
                        tab !== index ? "border-slate-700 opacity-50" : x.css
                      }`}
                      onClick={() => setTab(index)}
                    >
                      <img
                        src={x.iconSrc}
                        className="shrink-0 fill-slate-300 mr-3 my-auto"
                        width={x.iconWidth ?? 16}
                        height={x.iconHeight ?? 16}
                      />
                      <span>{x.title}</span>
                    </button>
                  ))}
              ...
              >
                <div className="relative py-24 -mt-12">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="relative w-48 sm:w-64 md:w-64 h-48 lg:w-72 lg:h-64 flex justify-center items-center">
                      {/* Halo effect */}
                      <svg
